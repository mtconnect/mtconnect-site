...
const Footer = () => (
  <footer className="bg-code-bg px-5 md:px-10 pt-12 pb-7">
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-[1.5fr_1fr_1fr_1fr] gap-8 mb-9">
      {/* Brand col */}
      <div>
    ...
    {/* Bottom bar */}
    <div className="border-t border-white/[0.07] pt-5 flex flex-col sm:flex-row gap-2 justify-between items-center text-center sm:text-left">
